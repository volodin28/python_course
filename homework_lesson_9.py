...
my_str_1 = "aaaasdf1"
my_str_2 = "asdfff2"
print(symb_intersection(my_str_1, my_str_2))
...
print(unique_symb_intersection(my_str_1, my_str_2))
...
from random import (randint, choice) #залишив тут для наглядності, але розумію, що потрібно підняти наверх документа
